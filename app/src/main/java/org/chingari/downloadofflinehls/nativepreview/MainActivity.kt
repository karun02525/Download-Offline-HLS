package org.chingari.downloadofflinehls.nativepreview
...
const val THUMBNAIL_MOSAIQUE = "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/images/BigBuckBunny.jpg"
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_nativepreview)
    ...
    private fun initPlayer(){
        ...
        exoProgress.addListener(object : TimeBar.OnScrubListener {
            override fun onScrubMove(timeBar: TimeBar, position: Long) {
                ...
                Log.d("TAGS","onScrubMove :  $position  max  $timeBar")
            ...
            override fun onScrubStop(timeBar: TimeBar, position: Long, canceled: Boolean) {
                Log.d("TAGS","onScrubStop :  $position  max  $timeBar")
                previewFrameLayout.visibility = View.INVISIBLE
            }

            override fun onScrubStart(timeBar: TimeBar, position: Long) {
                Log.d("TAGS","onScrubStart :  $position  max  $timeBar")
            }
        })
    ...
    private fun updatePreviewX(progress: Int, max: Int): Int {
        if (max == 0) { return 0 }
        Log.d("TAGS","progress :  $progress  max  $max")
